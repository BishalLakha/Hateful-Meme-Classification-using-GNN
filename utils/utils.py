...
data  = pd.read_csv("/home/bis/Projects/Classes/Deeplearning_class/project/data/all_data.csv")
...
def get_image_embeddings():
    """"Load image embeddings numpy and asign to train and test"""
    image_data = np.load("/home/bis/Projects/Classes/Deeplearning_class/project/data/additional_data/image_feature.npy", allow_pickle=True)

    # for i in image_data.item().keys():
#     print(i)
    train_embeddings = []
    test_embeddings = []
    for i in train_index:
        try:
            ...
            embedding = image_data.item()[image_name]
        except:
            image_name = str(i) +".png"
            image_name = str(0)+ image_name
            embedding = image_data.item()[image_name]
...
def load_data():
    ...
    # test_idx_reorder = 
    test_idx_range = np.sort(test_index)
    ...
    features[test_index, :] = features[test_idx_range, :]
    adj = nx.adjacency_matrix(nx.from_dict_of_lists(graph))

    labels = np.vstack((ally, ty))
    labels[test_index, :] = labels[test_idx_range, :]
    # print(len(labels))
